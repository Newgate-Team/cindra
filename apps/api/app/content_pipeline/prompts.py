...
_PLATFORM_GUIDANCE = {
    ...
    SocialPlatform.youtube: (
        "Формат: описание к видео на YouTube. Первые 1-2 предложения — самые "
        "важные (видны до разворачивания), дальше можно подробнее раскрыть тему "
        "обычными абзацами, в конце — 3-5 релевантных хэштегов."
    ),
    SocialPlatform.linkedin: (
        "Формат: пост в LinkedIn. Деловой, но не сухой тон, короткие абзацы "
        "(1-2 предложения) с пустой строкой между ними для читаемости, без "
        "лишних эмодзи, в конце — 3-5 профессиональных хэштегов по теме."
    ),
    SocialPlatform.reddit: (
        "Формат: пост на Reddit. Прямой, неформальный тон без рекламных "
        "интонаций (реддит-аудитория плохо реагирует на явный маркетинг), "
        "по существу с первого предложения, без хэштегов вообще — на "
        "Reddit они не приняты и не используются."
    ),
    SocialPlatform.twitter: (
        "Формат: твит для X (Twitter). Строго до 280 символов, одна "
        "мысль на пост, без вступлений — сразу суть, максимум 1-2 "
        "хэштега по теме, без длинных абзацев."
    ),
}
