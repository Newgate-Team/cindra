...
def test_upload_backup_keys_by_date(fake_r2: _FakeR2Client) -> None:
...
def test_backup_database_task_dumps_uploads_and_rotates(monkeypatch, fake_r2: _FakeR2Client) -> None:
    ...
    assert fake_r2.uploads[result] == b"dump-bytes"
