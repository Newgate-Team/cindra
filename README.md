...
Каталоги `packages/*` из спецификации остались пустыми заглушками (только README с описанием замысла) — пайплайн и интеграции живут пакетами внутри `apps/api/app/`.
